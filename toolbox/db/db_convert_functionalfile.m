...
% 
% Old to New
% sFunctionalFile = db_convert_anatomyfile(sAnatomy, 'channel')
% sFunctionalFile = db_convert_anatomyfile(sAnatomy, 'data')
% sFunctionalFile = db_convert_anatomyfile(sAnatomy, 'dipoles')
% sFunctionalFile = db_convert_anatomyfile(sAnatomy, 'headmodel')
% sFunctionalFile = db_convert_anatomyfile(sAnatomy, 'results')
% sFunctionalFile = db_convert_anatomyfile(sAnatomy, 'result')
% sFunctionalFile = db_convert_anatomyfile(sAnatomy, 'stat')
% sFunctionalFile = db_convert_anatomyfile(sAnatomy, 'timefreq')
% sFunctionalFile = db_convert_anatomyfile(sAnatomy, 'image')
% sFunctionalFile = db_convert_anatomyfile(sAnatomy, 'matrix')
% sFunctionalFile = db_convert_anatomyfile(sAnatomy, 'noisecov')
% sFunctionalFile = db_convert_anatomyfile(sAnatomy, 'ndatacov')
%
% @=============================================================================
