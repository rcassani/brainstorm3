function [ template ] = db_template(structureName, dataType)
...
if nargin < 2 || isempty(dataType)
    dataType = 2;         % Default values
else
    switch dataType
        case 'fields'
            dataType = 1; % Field types for metadata database
        case 'values'
            dataType = 2; % Default values
        case 'notnull'
            dataType = 3; % Not NULL in metadata database
        otherwise
            error('Unsupported data type requested.');
    end
end
...
switch lower(structureName)
    ...
    case 'subject'
        template = struct(...
            'Id',                  {'int', [], 1}, ...
            'Name',                {'str', 'Unnamed', 1}, ...
            'FileName',            {'str', 'Unnamed', 1}, ...
            'Comments',            {'str', [], 0}, ...
            'DateOfAcquisition',   {'str', [], 0}, ...
            'iAnatomy',            {'int', [], 0}, ...
            'iScalp',              {'int', [], 0}, ...
            'iCortex',             {'int', [], 0}, ...
            'iInnerSkull',         {'int', [], 0}, ...
            ...
            'iFEM',                {'int', [], 0}, ...
            'iOther',              {'int', [], 0}, ...
            'UseDefaultAnat',      {'bool', 0, 1} , ...
            'UseDefaultChannel',   {'bool', 1, 1}, ...
            'Anatomy',             {'skip', repmat(db_template('Anatomy'),0), 0}, ...
            'Surface',             {'skip', repmat(db_template('Surface'),0), 0});
    ...
    case 'protocolinfo'
        template = struct(...
            ...
            'iSubject',          [], ...
            'iStudy',            [], ...
            'iReadFiles',        containers.Map('KeyType','uint32','ValueType','uint32'), ...
            'UseDefaultAnat',    0, ...
            'UseDefaultChannel', 1, ...
            'Database',          db_template('DatabaseInfo'));
...
%             'Region',     'UU');   % 1st letter: Left/Right/Unknown,  2nd letter: Frontal/Parietal/Temporal/Occipital/Central/Unkown
    ...
    case 'sqltable'
        template = struct( ...
            'Name',       '', ...
            'Fields',     repmat(db_template('sqlfield'), 0), ...
            'PrimaryKey', []);
