...
%         jMenuFile.addSeparator();
    ...
    jPanelExplorer.setBorder(BorderFactory.createTitledBorder(''));
        ...
        jToolRefreshDatabase = gui_component('ToolbarButton', jToolbarSearch, [], [], {IconLoader.ICON_RELOAD, TB_DIM, jButtonGroup}, 'Refresh Database', @(h,ev)panel_protocols('UpdateTree'), []);
...
% =======================================
    ...
    GUI = struct(... % ==== Attributes ====
         'mainWindow', struct(...
             ...
             'jToolRefreshDatabase',   jToolRefreshDatabase, ...
